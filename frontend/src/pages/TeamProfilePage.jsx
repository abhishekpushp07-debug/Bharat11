...
const TEAM_DATABASE = {
  ...
  RCB: {
    ...
    history: `Royal Challengers Bengaluru is the most passionate fanbase in IPL history. Despite having legends like Virat Kohli, AB de Villiers, and Chris Gayle — arguably the greatest T20 batsmen ever assembled — RCB's wait finally ended in IPL 2025 when they lifted their maiden trophy.\n\n"Ee Sala Cup Namde" (This year the cup is ours) transformed from a meme to reality. Chinnaswamy Stadium on match night is the loudest, most electric atmosphere in world cricket.\n\nRCB holds the record for the highest individual score (Chris Gayle's 175* vs PWI in 2013), and Virat Kohli's unbreakable 973-run season in 2016. After reaching 3 finals (2009, 2011, 2016) and falling short each time, the 2025 triumph over PBKS in the final was the greatest moment in franchise history.`,
    history_hi: `RCB IPL का सबसे पैशनेट फैनबेस है — और 2025 में आखिरकार पहला खिताब जीता! विराट कोहली, AB डिविलियर्स, क्रिस गेल जैसे दिग्गज होने के बावजूद सालों तक इंतज़ार। "Ee Sala Cup Namde" 2025 में सच हो गया! चिन्नास्वामी का माहौल दुनिया में सबसे गर्म है।`,
    fun_facts: [
      'Chris Gayle scored 175* — highest individual IPL score',
      'Virat Kohli scored 973 runs in IPL 2016 — all-time record',
      'Led RCB to their maiden IPL title in 2025',
      'Most passionate fanbase — "Ee Sala Cup Namde" finally came true',
      '3 finals before 2025 (2009, 2011, 2016) — won it on the 4th attempt',
    ],
  ...
  SRH: {
    ...
    fun_facts: [
      ...
      'David Warner scored 3 Orange Caps for SRH',
      'Holds the IPL record for highest team total: 287/3 vs RCB (2024)',
      'Top 3 highest totals in IPL history all belong to SRH',
    ],
